...
#include <type_traits>
...
#ifndef INTERNAL_SNAP_HAS_BUILTIN_REFERENCE_CONVERTS_FROM_TEMPORARY
		...
		#define INTERNAL_SNAP_HAS_BUILTIN_REFERENCE_CONVERTS_FROM_TEMPORARY 0
	#endif
#endif // INTERNAL_SNAP_HAS_BUILTIN_REFERENCE_CONVERTS_FROM_TEMPORARY

#ifndef INTERNAL_SNAP_HAS_BUILTIN_REFERENCE_BINDS_TO_TEMPORARY
	#if defined(__NVCOMPILER) || defined(__NVCOMPILER_LLVM__)
		...
		#define INTERNAL_SNAP_HAS_BUILTIN_REFERENCE_BINDS_TO_TEMPORARY 0
	#endif
#endif // INTERNAL_SNAP_HAS_BUILTIN_REFERENCE_BINDS_TO_TEMPORARY
