#ifndef SNP_INCLUDE_SNAP_STOP_TOKEN_INTRUSIVE_SHARED_PTR_HPP
#define SNP_INCLUDE_SNAP_STOP_TOKEN_INTRUSIVE_SHARED_PTR_HPP
...
public:
	...
	intrusive_shared_ptr& operator=(const intrusive_shared_ptr& other) noexcept
	{
		...
		{
			if (other.m_ptr) { increment_ref_count(*other.m_ptr); }
			if (m_ptr) { decrement_ref_count(*m_ptr); }
			m_ptr = other.m_ptr;
		}
		return *this;
	}
...
#endif // SNP_INCLUDE_SNAP_STOP_TOKEN_INTRUSIVE_SHARED_PTR_HPP
