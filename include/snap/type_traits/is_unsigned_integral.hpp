#ifndef SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_UNSIGNED_INTEGRAL_HPP
#define SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_UNSIGNED_INTEGRAL_HPP
...
#endif // SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_UNSIGNED_INTEGRAL_HPP
