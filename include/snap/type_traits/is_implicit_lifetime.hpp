...
#else
    : std::bool_constant<
          std::is_scalar<std::remove_cv_t<T>>::value ||
          std::is_trivially_copyable<std::remove_cv_t<T>>::value> {};
#endif
 ...
 */
template <class T>
struct is_implicit_lifetime_impl : il_base<T> {};

/** @brief References are never implicit-lifetime. */
template <class T>
struct is_implicit_lifetime_impl<T&> : std::false_type {};
 ...
 */
template <class T>
struct is_implicit_lifetime_impl<T[]> : is_implicit_lifetime_impl<T> {};
...
struct is_implicit_lifetime_impl<T[N]> : is_implicit_lifetime_impl<T> {};
...
struct is_implicit_lifetime
    : detail::is_implicit_lifetime_impl<std::remove_cv_t<T>> {};
