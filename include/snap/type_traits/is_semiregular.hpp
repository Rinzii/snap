#ifndef SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_SEMIREGULAR_HPP
#define SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_SEMIREGULAR_HPP
...
#endif // SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_SEMIREGULAR_HPP
