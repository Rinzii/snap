#ifndef SNP_INCLUDE_SNAP_TYPE_TRAITS_POINTER_OF_HPP
#define SNP_INCLUDE_SNAP_TYPE_TRAITS_POINTER_OF_HPP
...
template <class T> struct pointer_of<
	T,
	std::enable_if_t<!is_detected_v<pointer_member_t, T> && !is_detected_v<element_type_member_t, T> && is_detected_v<pointer_traits_element_type_t, T>, void>>
{
...
#endif // SNP_INCLUDE_SNAP_TYPE_TRAITS_POINTER_OF_HPP
