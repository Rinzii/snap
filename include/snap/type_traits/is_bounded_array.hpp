#ifndef SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_BOUNDED_ARRAY_HPP
#define SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_BOUNDED_ARRAY_HPP
...
#endif // SNP_INCLUDE_SNAP_TYPE_TRAITS_IS_BOUNDED_ARRAY_HPP
