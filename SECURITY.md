...
We only support the latest released version of the Snap library, according
to [Semantic Versioning (SemVer)](https://semver.org/). If you are using an older version, we strongly encourage you to
upgrade to the latest version to ensure you receive any security updates.
...
3. **Acknowledgment**: We will acknowledge your report within 7 days and provide an estimated timeline for addressing
   the vulnerability.
