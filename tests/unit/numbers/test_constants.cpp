...
struct is_numbers_constant_available : std::false_type
{
};

template <class T>
struct is_numbers_constant_available<T, std::void_t<decltype(snap::numbers::pi_v<T>)>> : std::true_type
{
};
...
template <class T>
class NumbersTypedTest : public ::testing::Test
{
};
