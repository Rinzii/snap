#ifndef SNP_TESTS_UNIT_STOP_TOKEN_ATOMIC_UNIQUE_LOCK_HPP
#define SNP_TESTS_UNIT_STOP_TOKEN_ATOMIC_UNIQUE_LOCK_HPP
...
#endif // SNP_TESTS_UNIT_STOP_TOKEN_ATOMIC_UNIQUE_LOCK_HPP
