#ifndef SNP_TESTS_UNIT_TYPE_TRAITS_IS_SIGNED_INTEGRAL_HPP
#define SNP_TESTS_UNIT_TYPE_TRAITS_IS_SIGNED_INTEGRAL_HPP
...
#endif // SNP_TESTS_UNIT_TYPE_TRAITS_IS_SIGNED_INTEGRAL_HPP
