#ifndef SNP_TESTS_UNIT_TYPE_TRAITS_IS_ASSIGNABLE_FROM_HPP
#define SNP_TESTS_UNIT_TYPE_TRAITS_IS_ASSIGNABLE_FROM_HPP
...
#endif // SNP_TESTS_UNIT_TYPE_TRAITS_IS_ASSIGNABLE_FROM_HPP
