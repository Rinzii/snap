#ifndef SNP_TESTS_UNIT_TYPE_TRAITS_IS_IMPLICIT_LIFETIME_HPP
#define SNP_TESTS_UNIT_TYPE_TRAITS_IS_IMPLICIT_LIFETIME_HPP
...
#endif // SNP_TESTS_UNIT_TYPE_TRAITS_IS_IMPLICIT_LIFETIME_HPP
